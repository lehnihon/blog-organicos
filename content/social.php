...
<div class="social-url">
        <?php if ( of_get_option('facebook_url') ) {
         ...
         <?php if ( of_get_option('twitter_url') ) {
              $twitter_url = esc_url(of_get_option('twitter_url', ''));
         ...
         <?php if ( of_get_option('google_url') ) {
              $google_url = esc_url(of_get_option('google_url', ''));
        ...
        <?php if ( of_get_option('pinterest_url') ) {
              $pinterest_url = esc_url(of_get_option('pinterest_url', ''));
        ...
        <?php if ( of_get_option('tumblr_url') ) {
              $tumblr_url = esc_url(of_get_option('tumblr_url', ''));
        ...
        <?php if ( of_get_option('instagram_url') ) {
              $instagram_url = esc_url(of_get_option('instagram_url', ''));
        ...
        <?php if ( of_get_option('linkedin_url') ) {
              $linkedin_url = esc_url(of_get_option('linkedin_url', ''));
        ...
        <?php if ( of_get_option('dribbble_url') ) {
              $dribbble_url = esc_url(of_get_option('dribbble_url', ''));
         ...
         <?php if ( of_get_option('vimeo_url') ) {
              $vimeo_url = esc_url(of_get_option('vimeo_url', ''));
        ...
        <?php if ( of_get_option('youtube_url') ) {
              $youtube_url = esc_url(of_get_option('youtube_url', ''));
        ...
        <?php if ( of_get_option('rss_url') ) {
              $rss_url = esc_url(of_get_option('rss_url', ''));
